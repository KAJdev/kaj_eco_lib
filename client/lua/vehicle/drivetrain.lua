...
local function init()
  ...
  -- <custom>
	--obj:queueGameEngineLua("extensions.addModulePath('lua/vehicle/extensions/kaj_eco_lib')")
  --obj:queueGameEngineLua("extensions.loadModulesInDirectory('lua/vehicle/extensions/kaj_eco_lib')")

  obj:queueGameEngineLua("extensions.addModulePath('lua/ge/extensions/kaj_eco_lib')")
  obj:queueGameEngineLua("extensions.loadModulesInDirectory('lua/ge/extensions/kaj_eco_lib')")
  -- </custom>
end
